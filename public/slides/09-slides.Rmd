...
.box-1.small.sp-after-half[**Repaso de construcción de modelos**]
...
.box-1[Antes de finalizar...]

.box-5[**Desafío** *(0.5 décimas para la tarea N°4)*]
.box-5.small[Construir una tabla *única* con modelo de regresión lineal y logístico con los datos de la tarea N°4  con el paquete **texreg**. Debe especificar *bien* todos los predictores]
.box-5[Fecha: hasta el día __miércoles a las 20 horas__ por canal *#04-tareas*. Debe entregar el código de `texreg` y un pantallazo de la tabla]
---
